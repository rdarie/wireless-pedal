 ...
 *
 * BLESerial class implements same protocols as Arduino's built-in Serial class and can be used as its wireless
...
void setup() {
  ...
  // make the motor's pin an output:
